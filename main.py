...
print (colorama.Fore.LIGHTBLUE_EX, "\t\t\t\t\t\t\t\tMADE BY:- UNKNOWN...")
...
if word.lower() == name:
    ...
    win = False
    print (f"{word} is the servent of arsal.")
    print ("Not matched")
    print ("YOU LOSE!")
